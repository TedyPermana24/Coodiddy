...
<body class="flex items-center justify-center min-h-screen bg-gradient-to-r from-[#c8a279] to-[#6b4423] via-[#c8a279] font-poppins">
            ...
            <div>
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-4">
                    ...
                    <div class="relative shadow-lg mx-auto w-80">
                        ...
                        <img src="{{ asset('svg/eye-solid.svg') }}" alt="Toggle Email" class="absolute right-3 top-3 w-6 h-6 cursor-pointer">
